...
import 'package:duare_medicine/Dialog/CustomDialog.dart';
...
setState(() {
  ...
  Future addProduct() async {
    ...
    var postUri = Uri.parse("https://admin.duare.net/api/shopApi/medicine_add.php");
    var request = new http.MultipartRequest("POST", postUri);
  request.fields['product_name'] =et_name.text;
    request.fields['pharmacy_id'] =dataSharePre;
    request.fields['Medicine_Catagory'] =et_desc.text;
    request.fields['Medicine_Size'] =et_size.text;
    request.fields['medicine_company'] =et_complanyName.text;
    ...
    request.fields['Medicine_Type'] ='available';
    request.fields['Medicine_Power'] ='available';
    if( galaryFile != null){
      print('Not null');
